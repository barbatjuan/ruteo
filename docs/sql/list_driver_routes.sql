-- Lista rutas del conductor para una fecha, excluyendo paradas que coinciden con la ubicación de la empresa (~50m)
-- Devuelve totales ya filtrados para mostrarlos correctamente en la vista del Driver
create or replace function public.list_driver_routes(
  p_tenant uuid,
  p_date date
) returns table (
  id uuid,
